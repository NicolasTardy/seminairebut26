...
const honorees = [
  {
    ...
    subtitle: "Mobilité interne · Un parcours exceptionnel",
    name: "Audrey Barna",
    badgeIcon: "⏳",
    visual: "timewarp",
    reason: "Pour avoir accompli une transition de cinq mois entre son poste d'Account Manager Marketplace et celui de Chef de Projet Retail Media Marketplace. Bravo Audrey !",
  },
  {
    id: "margaux-beudet",
    ...
    badgeIcon: "💎",
    visual: "million",
    reason: "Pour avoir contribué à un record historique de revenus Retail Media pour BUT avec 1,5 million d'euros générés. Félicitations Margaux !",
  },
  {
    id: "virginie-nerriere",
    title: "Oscar de l'Éternel Sourire",
    subtitle: `Prix "Eternal sunshine of the spotless mind"`,
    name: "Virginie Nerrière",
    badgeIcon: "☀️",
    visual: "sunshine",
    reason: "Autour d'elle tout a changé : son manager, son équipe, son bureau, ses partenaires et ses missions. Et pourtant, elle a conservé ce qui la caractérise le mieux : son sourire et son énergie positive. Bravo Virginie !",
  },
  {
    id: "perola-pessaro",
    title: "Prix Mission Impossible",
    subtitle: "Nouvelle campagne publicitaire",
    name: "Pérola Pessaro",
    badgeIcon: "🎬",
    visual: "mission",
    reason: "Pour avoir plongé avec enthousiasme dans le projet de nouvelle campagne publicitaire et avoir embrassé de nouvelles responsabilités avec une remarquable capacité d'adaptation. Félicitations Pérola !",
  },
  {
    id: "team-marketplace",
    title: `Oscar "The Social Network"`,
    subtitle: "La team drivée par l'obsession de la croissance",
    name: "Team Marketplace",
    badgeIcon: "🌐",
    visual: "network",
    reason: "Pour son engagement collectif au service du business et sa contribution à une croissance soutenue dans un environnement e-commerce particulièrement dynamique. Bravo à toute l'équipe !",
  },
  {
    id: "team-pei",
    ...
    badgeIcon: "🚀",
    visual: "futur",
    reason: "Pour avoir insufflé une nouvelle dynamique d'équipe tournée vers les tendances, l'innovation et les opportunités de demain. Bravo à toute l'équipe !",
  },
  {
    ...
    visual: "ai",
    reason: "Pour s'être approprié les outils d'intelligence artificielle en un temps record et pour développer une approche innovante et technique au service de ses projets. Félicitations Valérie !",
  },
  {
    id: "anais-melanie-speed",
    title: `Prix "Speed 2"`,
    subtitle: "Plus rapides que Keanu Reeves",
    name: "Anaïs Mastio & Mélanie Coupron",
    badgeIcon: "💨",
    visual: "speed",
    reason: "Pour leur capacité à lancer, coordonner et faire avancer les projets avec une rapidité remarquable. Bravo à toutes les deux !",
  },
  {
    id: "emilie-pele-hp",
    title: "Oscar Harry Potter — L'alternante sorcière devenue grande",
    subtitle: "Montée en compétences Responsys",
    name: "Émilie Pelé",
    badgeIcon: "⚡",
    visual: "hogwarts",
